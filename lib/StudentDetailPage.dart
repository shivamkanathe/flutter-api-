    ...
    return Scaffold(
      ...
      body: Container(
        ...
        color: Colors.white,
            ...
            // Text("Student Name :- ${widget.mydata.user} "),
            // Text("Student SchoolName :- ${widget.mydata.schoolName} "),
            // Text("Student ContactNumber :- ${widget.mydata.contactNumber}"),
            // Text("Student Age :- ${widget.mydata.age}"),
          ],
        ),
      ),
    );
